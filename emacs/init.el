...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org-evil evil-org jedi websocket sr-speedbar treemacs swiper counsel imenu-list evil-indent-plus helm-projectile helm-ag-r helm-ag ranger helm spacemacs-theme use-package powerline php-mode evil-surround evil-leader elpy))))
(custom-set-faces
